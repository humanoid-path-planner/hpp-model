...
#ifndef HPP_MODEL_EXTRA_CONFIG_SPACE_HH
#define HPP_MODEL_EXTRA_CONFIG_SPACE_HH
...
namespace hpp {
  namespace model {
    ...
    {
    public:
      ExtraConfigSpace () : dimension_ (0), lowerBounds_ (0,0), upperBounds_ (0,0)
      {
      }
...
#endif // HPP_MODEL_EXTRA_CONFIG_SPACE_HH
